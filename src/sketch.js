...
const rotate = (A, lvl = level) => {
  ...
  console.log(B);
  B = [
    ...toArray(iT(split(rotate(B[0], lvl-1)))),
    ...toArray(iT(split(rotate(B[2], lvl-1)))),
    ...toArray(iT(split(rotate(B[3], lvl-1)))),
    ...toArray(iT(split(rotate(B[1], lvl-1)))),
    // ...rotate(B[2], lvl-1),
    // ...rotate(B[3], lvl-1),
  ];
  return B;
